...
const executorMap: Record<string, (input: Record<string, unknown>) => Promise<ToolOutput>> = {
  ...
  'color-picker': (input) => import('@/tools/implementations/colorTools').then(m => m.colorPicker(input)),
  'gradient-generator': (input) => import('@/tools/implementations/colorTools').then(m => m.gradientGenerator(input)),
  'palette-generator': (input) => import('@/tools/implementations/colorTools').then(m => m.paletteGenerator(input)),
  'color-format-convert': (input) => import('@/tools/implementations/colorTools').then(m => m.colorFormatConvert(input)),
  'image-color-extract': (input) => import('@/tools/implementations/colorTools').then(m => m.imageColorExtract(input)),
  'base64-encode': (input) => import('@/tools/implementations/encodingTools').then(m => m.base64Encode(input)),
  'url-encode': (input) => import('@/tools/implementations/encodingTools').then(m => m.urlEncode(input)),
  'hash-generate': (input) => import('@/tools/implementations/encodingTools').then(m => m.hashGenerate(input)),
  'unicode-convert': (input) => import('@/tools/implementations/encodingTools').then(m => m.unicodeConvert(input)),
  'morse-convert': (input) => import('@/tools/implementations/encodingTools').then(m => m.morseConvert(input)),
  'id-card-parser': (input) => import('@/tools/implementations/identityTools').then(m => m.idCardParser(input)),
  'phone-number-locator': (input) => import('@/tools/implementations/identityTools').then(m => m.phoneNumberLocator(input)),
  'bank-card-validator': (input) => import('@/tools/implementations/identityTools').then(m => m.bankCardValidator(input)),
  'number-to-chinese': (input) => import('@/tools/implementations/identityTools').then(m => m.numberToChinese(input)),
  'image-to-base64': (input) => import('@/tools/implementations/imageBeautyTools').then(m => m.imageToBase64(input)),
  ...
  'online-ruler': (input) => import('@/tools/implementations/measurementTools').then(m => m.onlineRuler(input)),
  'screen-info': (input) => import('@/tools/implementations/measurementTools').then(m => m.screenInfo(input)),
  'random-number-generator': (input) => import('@/tools/implementations/measurementTools').then(m => m.randomNumberGenerator(input)),
  'number-base-converter': (input) => import('@/tools/implementations/measurementTools').then(m => m.numberBaseConverter(input)),
