  ...
  return (
    <>
      ...
      <button
        ...
        aria-expanded={open}
        className="fixed top-4 right-4 z-[300] flex items-center gap-1.5 min-w-[44px] min-h-[44px] px-3.5 py-2 rounded-full bg-accent text-black shadow-lg shadow-accent/25 hover:bg-accent/90 active:scale-95 transition-all"
      >
        <ShareIcon className="w-5 h-5" />
        <span className="hidden sm:inline text-sm font-semibold">分享</span>
      </button>
